...
- For generated domain tables, update the source model file first (for example `db/model/phase2_schema.json`, `db/model/phase3_schema.json`, `db/model/phase4_schema.json`, `db/model/phase5_schema.json`), then regenerate artifacts with `scripts/generate_db_artifacts.py`.
